...
func ResolveURL(c *fiber.Ctx) error {
	...
	defer rd0.Close()               // defer -> it waits for all the process to complete and then closes instance of redis
	...
	return c.Redirect(value, fiber.StatusMovedPermanently) // Returns original URL
}
